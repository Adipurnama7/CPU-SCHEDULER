...
$(document).ready(function () {
	...
	function run() {
		...
		if (processArray.length > 0) {
			...
			if (algorithm == "FCFS") {
				$("#algorithm_explanation").text("First Come First Served akan menjalankan proses sesuai urutan kedatangannya");
				FCFS();
				processTotal = processArray;
			}

			else if (algorithm == "SJF") {
				$("#algorithm_explanation").text("Shortest Job First akan mengeksekusi proses dari yang terkecil hingga terbesa");
				SJF();
				processTotal = processArray;
			}
				...
				SRJF();
				$("#algorithm_explanation").text("Shortest Remaining Job First akan menjalankan proses dari yang terkecil hingga terbesar. Jika ada proses baru yang datang dengan ukuran lebih kecil dari proses yang sedang berjalan, maka proses tersebut akan terhenti.");
				processTotal = processArray;
			}

			else if (algorithm == "Round Robin") {
				$("#algorithm_explanation").text("Round Robin akan mengeksekusi setiap proses selama durasi kuantum waktu. Kemudian akan melanjutkan ke proses berikutnya. ");
				roundRobin();
				processTotal = processArray;
				tq = timeQuantum;
			}
